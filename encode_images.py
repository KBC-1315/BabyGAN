...
def main():
    ...
    parser.add_argument('--data_dir', default='./content/data', help='Directory for storing optional models')
    parser.add_argument('--mask_dir', default='./content/masks', help='Directory for storing optional masks')
    ...
    parser.add_argument('--model_url', default='./content/BabyGAN/karras2019stylegan-ffhq-1024x1024.pkl', help='Fetch a StyleGAN model to train on from this URL')
    parser.add_argument('--architecture', default='./content/BabyGAN/vgg16_zhang_perceptual.pkl', help='Сonvolutional neural network model from this URL')
    ...
    parser.add_argument('--load_effnet', default='./content/data/finetuned_effnet.h5', help='Model to load for EfficientNet approximation of dlatents')
    parser.add_argument('--load_resnet', default='./contentdata/finetuned_resnet.h5', help='Model to load for ResNet approximation of dlatents')
    ...
    # Video params
    parser.add_argument('--video_dir', default='./content/videos', help='Directory for storing training videos')
